    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","https://dzb-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/qq_code.png");
        $('.weixin_code').attr("src","https://dzb-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/weixin_code.png");
    });
