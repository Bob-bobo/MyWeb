...
public enum CodeType {
    ...
    DELETE_CALLIGRAPHY_FAIL(201, "删除书法失败"),
    CALLIGRAPHY_HAS_THUMBS_UP(202, "书法已经点过赞了"),
    CALLIGRAPHY_NOT_EXIST(203, "书法不存在"),
    PUBLISH_CALLIGRAPHY_NO_PERMISSION(204, "发表书法没有权限"),

    FIND_TAGS_CLOUD(301, "获得所有标签成功"),
    FIND_CALLIGRAPHY_BY_TAG(302, "通过标签获得书法成功"),

    ADD_CATEGORY_SUCCESS(401, "添加分类成功"),
    CATEGORY_EXIST(402, "分类已存在"),
    DELETE_CATEGORY_SUCCESS(403, "删除分类成功"),
    CATEGORY_NOT_EXIST(404, "分类不存在"),
    CATEGORY_HAS_CALLIGRAPHY(405, "分类下存在书法，删除失败"),
