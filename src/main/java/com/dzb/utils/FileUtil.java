...
import com.dzb.constant.OSSClientConstants;
...
public class FileUtil {
    ...
    public String uploadFile(File file, String subCatalog){
        ...
        //初始化OSSClient
        OSSClient ossClient = com.dzb.utils.AliYunOSSClientUtil.getOSSClient();

        String md5Key = com.dzb.utils.AliYunOSSClientUtil.uploadObject2OSS(ossClient, file, OSSClientConstants.BACKET_NAME,
                OSSClientConstants.FOLDER + subCatalog + "/");
        String url = com.dzb.utils.AliYunOSSClientUtil.getUrl(ossClient, md5Key);
    ...
    public File multipartFileToFile(MultipartFile multipartFile, String filePath, String fileName){
        ...
        if(com.dzb.utils.StringUtil.BLANK.equals(multipartFile) || multipartFile.getSize() <= 0){
            multipartFile = null;
        } else {
            try {
